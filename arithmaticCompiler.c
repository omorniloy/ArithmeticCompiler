...
/* Notes
	This entire code depends heavily on the acCII character set
	...
	The plan wac to use dynamic memory allocation throughout the entire project, but I ran into a couple sections where I kept getting mem bugs that I couldn't fix,
		so I had to switch to static allocation in those areac
*/
...
long long convert_ac_to_number(char * ac);
int retrieve_label_or_number(char* data, char** ret);
bool add_ret_addr(long long addr);
long long get_lact_ret_addr(void);
void step_through_program(char * source);

// All the functions representing actual whitespace instructions
void ac_stack_push(char* parameter, int size);
void ac_stack_dup(char* parameter, int size);
void ac_stack_copy(char* parameter, int size);
void ac_stack_swap(char* parameter, int size);
void ac_stack_discard(char* parameter, int size);
void ac_stack_slide(char* parameter, int size);
void ac_math_add(char* parameter, int size);
void ac_math_sub(char* parameter, int size);
void ac_math_mult(char* parameter, int size);
void ac_math_div(char* parameter, int size);
void ac_math_mod(char* parameter, int size);
void ac_heap_store(char* parameter, int size);
void ac_heap_retrieve(char* parameter, int size);
void ac_flow_mark(char* parameter, int size);
void ac_flow_call(char* parameter, int size);
void ac_flow_jump(char* parameter, int size);
void ac_flow_jz(char* parameter, int size);
void ac_flow_jn(char* parameter, int size);
void ac_flow_ret(char* parameter, int size);
void ac_flow_exit(char* parameter, int size);
void ac_io_outc(char* parameter, int size);
void ac_io_outn(char* parameter, int size);
void ac_io_inc(char* parameter, int size);
void ac_io_inn(char* parameter, int size);
...
int main(int argc, char** argv)
{
	...
	if (argc == 2) {
		...
		printf("Proper Usage: %s file.arc\n", argv[0]);
	return 1;
}
...
void remove_comments(char* buffer)
{
	...
	for (int i = 0; buffer[i]; i++) {
		if (buffer[i] != '\x2A' && buffer[i] != '\x3D' && buffer[i] != '\x2B') {
...
bool create_instruction_set(void)
{
	...
	instruction_set.unique_id[0] = "\x2B\x2B";
	instruction_set.instruction_function[0] = &ac_stack_push;
	instruction_set.instruction_size[0] = 2;

	instruction_set.unique_id[1] = "\x2B\x3D\x2B";
	instruction_set.instruction_function[1] = &ac_stack_dup;
	instruction_set.instruction_size[1] = 3;

	instruction_set.unique_id[2] = "\x2B\x2A\x2B";
	instruction_set.instruction_function[2] = &ac_stack_copy;
	instruction_set.instruction_size[2] = 3;

	instruction_set.unique_id[3] = "\x2B\x3D\x2A";
	instruction_set.instruction_function[3] = &ac_stack_swap;
	instruction_set.instruction_size[3] = 3;

	instruction_set.unique_id[4] = "\x2B\x3D\x3D";
	instruction_set.instruction_function[4] = &ac_stack_discard;
	instruction_set.instruction_size[4] = 3;

	instruction_set.unique_id[5] = "\x2B\x2A\x3D";
	instruction_set.instruction_function[5] = &ac_stack_slide;
	instruction_set.instruction_size[5] = 3;

	// Arithmetic - [Tab][Space]
	instruction_set.unique_id[6] = "\x2A\x2B\x2B\x2B";
	instruction_set.instruction_function[6] = &ac_math_add;
	instruction_set.instruction_size[6] = 4;

	instruction_set.unique_id[7] = "\x2A\x2B\x2B\x2A";
	instruction_set.instruction_function[7] = &ac_math_sub;
	instruction_set.instruction_size[7] = 4;

	instruction_set.unique_id[8] = "\x2A\x2B\x2B\x3D";
	instruction_set.instruction_function[8] = &ac_math_mult;
	instruction_set.instruction_size[8] = 4;

	instruction_set.unique_id[9] = "\x2A\x2B\x2A\x2B";
	instruction_set.instruction_function[9] = &ac_math_div;
	instruction_set.instruction_size[9] = 4;

	instruction_set.unique_id[10] = "\x2A\x2B\x2A\x2A";
	instruction_set.instruction_function[10] = &ac_math_mod;
	instruction_set.instruction_size[10] = 4;

	// Heap access - [Tab][Tab]
	instruction_set.unique_id[11] = "\x2A\x2A\x2B";
	instruction_set.instruction_function[11] = &ac_heap_store;
	instruction_set.instruction_size[11] = 3;

	instruction_set.unique_id[12] = "\x2A\x2A\x2A";
	instruction_set.instruction_function[12] = &ac_heap_retrieve;
	instruction_set.instruction_size[12] = 3;

	// Flow Control - [LF]
	instruction_set.unique_id[13] = "\x3D\x2B\x2B";
	instruction_set.instruction_function[13] = &ac_flow_mark;
	instruction_set.instruction_size[13] = 3;

	instruction_set.unique_id[14] = "\x3D\x2B\x2A";
	instruction_set.instruction_function[14] = &ac_flow_call;
	instruction_set.instruction_size[14] = 3;

	instruction_set.unique_id[15] = "\x3D\x2B\x3D";
	instruction_set.instruction_function[15] = &ac_flow_jump;
	instruction_set.instruction_size[15] = 3;

	instruction_set.unique_id[16] = "\x3D\x2A\x2B";
	instruction_set.instruction_function[16] = &ac_flow_jz;
	instruction_set.instruction_size[16] = 3;

	instruction_set.unique_id[17] = "\x3D\x2A\x2A";
	instruction_set.instruction_function[17] = &ac_flow_jn;
	instruction_set.instruction_size[17] = 3;

	instruction_set.unique_id[18] = "\x3D\x2A\x3D";
	instruction_set.instruction_function[18] = &ac_flow_ret;
	instruction_set.instruction_size[18] = 3;

	instruction_set.unique_id[19] = "\x3D\x3D\x3D";
	instruction_set.instruction_function[19] = &ac_flow_exit;
	instruction_set.instruction_size[19] = 3;

	// Input/Output - [Tab][LF]
	instruction_set.unique_id[20] = "\x2A\x3D\x2B\x2B";
	instruction_set.instruction_function[20] = &ac_io_outc;
	instruction_set.instruction_size[20] = 4;

	instruction_set.unique_id[21] = "\x2A\x3D\x2B\x2A";
	instruction_set.instruction_function[21] = &ac_io_outn;
	instruction_set.instruction_size[21] = 4;

	instruction_set.unique_id[22] = "\x2A\x3D\x2A\x2B";
	instruction_set.instruction_function[22] = &ac_io_inc;
	instruction_set.instruction_size[22] = 4;

	instruction_set.unique_id[23] = "\x2A\x3D\x2A\x2A";
	instruction_set.instruction_function[23] = &ac_io_inn;
...
bool locate_jump_labels(char* source)
{
	...
	char* label_marker = "\x3D\x2B\x2B", * temp;
	for (int i = 0; source[i]; i++) {
		if (!strncmp(&(source[i]), label_marker, 3) && (source[i-1] != '\x2A')) {
			if (label_table.label_id[label_index] = (char*)calloc(MAX_LABEL_LENGTH, sizeof(char))) {
				...
				for (j = 0; source[i + j] != '\x3D'; j++) label_table.label_id[label_index][j] = source[i + j];
				i += j;
				label_table.label_location[label_index] = i + 1; // The 1 puts it pact the final \x3D
				label_index++;
				continue;
...
void ac_stack_push(char* parameter, int size)
{
	...
	if (leap = retrieve_label_or_number(&(parameter[size]), &label_number)) {
		stack_push(convert_ac_to_number(label_number));
...
void ac_stack_copy(char* parameter, int size)
{
	...
	int leap = 0;
	if (leap = retrieve_label_or_number(&(parameter[size]), &label_number)) {
		stack_push(stack_peak(convert_ac_to_number(label_number)));
		current_instruction_index += size + leap + 1;
		free (label_number);
	}
	else
...
void ac_stack_slide(char* parameter, int size)
{
	...
	char* label_number = NULL;
	if (leap = retrieve_label_or_number(&(parameter[size]), &label_number)) {
		for (int slide_amt = convert_ac_to_number(label_number); slide_amt > 0; slide_amt--)
			stack_pop();
		stack_push(first);
		current_instruction_index += size + leap + 1;
		free (label_number);
...
void ac_flow_ret(char* parameter, int size)
{
	current_instruction_index = get_lact_ret_addr();
	return;
}
